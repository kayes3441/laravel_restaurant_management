...
!function (e, t) {
    ...
    function o(e, t) {
        var n = [], a = moment(e.start.toUTCString());
    ...
    function r(e) {
        var t = $(e.target).closest('a[role="menuitem"]')[0], n = f(t), a = l.getOptions(), o = "";
    ...
    function s() {
        var e = $("#new-schedule-title").val(), t = $("#new-schedule-location").val(),
            n = document.getElementById("new-schedule-allday").checked, a = c.getStartDate(), o = c.getEndDate(),
            r = i || CalendarList[0];
        e && (l.createSchedules([{
    ...
    function m(e) {
        var t = e.target.value, n = e.target.checked, a = document.querySelector(".lnb-calendars-item input"),
            o = Array.prototype.slice.call(document.querySelectorAll("#calendarList input")), r = !0;
    ...
    function k() {
        var e = document.getElementById("calendarTypeName"), t = document.getElementById("calendarTypeIcon"),
            n = l.getOptions(), a = l.getViewName(),
    ...
    function p() {
        var e = document.getElementById("renderRange"), t = l.getOptions(), n = l.getViewName(), a = [];
    ...
    (l = new t("#calendar", {
        ...
        clickMore: function (e) {
            ...
            console.log("beforeCreateSchedule", e), function (e) {
                var t = e.calendar || findCalendar(e.calendarId), n = {
                    id: String(chance.guid()),
                    title: e.title,
                    isAllDay: e.isAllDay,
                    start: e.start,
            ...
            }) : l.setTheme({"week.daygridLeft.width": "60px", "week.timegridLeft.width": "60px"}), !0
        }
...
}(window, tui.Calendar), function () {
    var e = document.getElementById("calendarList"), t = [];
    CalendarList.forEach(function (e) {
